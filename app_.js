...
var key = fs.readFileSync('/etc/letsencrypt/archive/laboaintelligente.it/privkey1.pem');
var cert = fs.readFileSync( '/etc/letsencrypt/archive/laboaintelligente.it/cert1.pem' );
var ca = fs.readFileSync( '/etc/letsencrypt/archive/laboaintelligente.it/fullchain1.pem' );
