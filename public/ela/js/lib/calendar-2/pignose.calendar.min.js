...
! function(a, b) {
    ...
    return function(a) {
        ...
        var i = g(a),
            ...
            n = {
                supports: ["en", "ko", "fr", "ch", "de", "jp", "pt", "da", "pl", "es", "it"],
                weeks: {
                        ...
                        w.renderer = function() {
                            ...
                            for (var F = w.dateManager.firstDay; F <= w.dateManager.lastDay; F++) {
                                var I = c.Convert(w.dateManager.year, w.dateManager.month, F),
                                    ...
                                    H = g(d.Format('<div class="{0} {0}-date {0}-{3}" data-date="{1}" onclick="window.location=\'/tables/{1}\';"><a href="#">{2}</a></div>', d.GetSubClass("Unit"), I.format("YYYY-MM-DD"), F, n.weeks.en[I.weekday()].toLowerCase()));
